...
Effort is NOT a savings knob: EVERY delegated agent — implementation, judgment, verification,
...
discipline is EFFORT-INDEPENDENT: it applies unchanged at whatever
effort the chair runs, and needs no special mode.
